            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    { icon: Smartphone, label: "SAAS App Development", arrow: true },
                    { icon: Code, label: "Mobile App Development", arrow: true },
                    { icon: Globe, label: "Web App Development", arrow: true },
                    { icon: Code, label: "Custom Software", arrow: true },
                    { icon: Smartphone, label: "MVP Development", arrow: true },
                    { icon: Globe, label: "Legacy App Modernization", arrow: true }
                  ].map((service, index) => (
                    <div key={index} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors">
                      ...
                      {service.arrow && <ArrowRight className="h-4 w-4 text-gray-400" />}
                    </div>
                  ))}
                </div>
              </div>
